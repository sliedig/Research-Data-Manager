...
{
    [TestFixture]
    class DataCollectionApprovalViewModelStep2BinderShould
    {
        ...
        public void Create_viewmodel_with_seocodes_and_forcodes()
        {
            ...
            var binder = new DataCollectionApprovalViewModelStep2Binder {DataCollectionRepository = _dataCollectionRepository};
